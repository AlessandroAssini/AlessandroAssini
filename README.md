...
NLP group project built around a quiz assistant powered by local open-weight LLMs, combining retrieval-augmented generation, semantic search, speech interaction and agentic AI techniques.

**Tech:** Python · PyTorch · Hugging Face · FAISS · RAG

### 🛡️ [ASPIS](https://github.com/AlessandroAssini/ASPIS)
Testing and validation of **ASPIS — Automatic Software-based Protection and Integrity Suite**, an LLVM-based tool that transforms Intermediate Representation to improve resilience against Single-Event Upsets.

**Tech:** C++ · LLVM · CMake · Compiler Passes

### 🎲 [MyShelfie](https://github.com/AlessandroAssini/Project-Ingegneria-del-Software-2023)
Java client-server implementation of a multiplayer board game with MVC architecture, Socket/RMI communication, CLI and GUI interfaces, integrated chat and concurrent game sessions.

**Tech:** Java · Maven · Socket/RMI · JavaFX

### 🏥 [Clinical Trial Workflow](https://github.com/AlessandroAssini/ClinicalTrial)
...
### 🔌 [Digital Hardware Design](https://github.com/AlessandroAssini/bitroute-vhdl)
...
### 🧹 [Data Quality](https://github.com/AlessandroAssini/milan-data-care)
...
### ⏱️ [Performance Evaluation](https://github.com/AlessandroAssini/SystemPerformanceModels)
Performance-modelling challenges covering computing systems, microservices, caching, RAID, hybrid-cloud infrastructures and queueing networks.

**Tech:** Python · JMT · Queueing Networks · Performance Modelling

### 📡 [Internet of Things](https://github.com/AlessandroAssini/iot-challenges)
...
[LinkedIn](https://www.linkedin.com/in/alessandroassini/) · [Email](mailto:alessandro.assini@hotmail.it)
